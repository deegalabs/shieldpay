    ...
    <div className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-6 py-12">
      ...
      <div className="mt-8">
        ...
        <ol className="space-y-3">
          <Step done icon={<Check size={15} />} title="Create your company" body="Your workspace and receipt details." />
          <Step icon={<Send size={15} />} title="Run your first payroll" body="Pay a contractor and prove it on-chain." />
          <Step icon={<FileCheck size={15} />} title="Get the court-grade receipt" body="A verifiable PDF, ready for any audit." />
        </ol>
      </div>
    </div>
  );
